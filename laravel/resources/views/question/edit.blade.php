            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form action="http://localhost/laravel-zhihu/laravel/public/questions/{{ $question->id}}" method="post" >
                            {{method_field('PATCH')}}
                            {{csrf_field()}}
                            ...
                            <button class="btn btn-success pull-right" type="submit">重新发布</button>
                        </form>
                    </div>
                </div>
            </div>
